<template>
  ...
  <header class="header">
    <div class="logo">Ficção Científica</div>
...
.header {
  ...
  background: linear-gradient(90deg, #000000, #38bdf8);
  color: white;
